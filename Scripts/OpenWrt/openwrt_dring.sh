...
# Function: Use Flippy's kernel files and script to package openwrt
# Copyright (C) flippy https://github.com/unifreq/openwrt_packit
# Copyright (C) ophub https://github.com/ophub/flippy-openwrt-actions
#
#======================================= Functions list =======================================
#
...
#KERNEL_REPO_URL_VALUE="FoxDring/UniversalOS"
...
SCRIPT_QEMU_FILE="Scripts/OpenWrt/mk_qemu-aarch64_img.sh"  #qemu
...
SCRIPT_S905D_FILE="Scripts/OpenWrt/mk_s905d_n1.sh"  #s905d_n1
...
WHOAMI_VALUE="dring"
OPENWRT_VER_VALUE="R$(date +%Y.%m.%d)"  #auto
